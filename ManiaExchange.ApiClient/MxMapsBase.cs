...
public class MxMapsBase<T> : MxBase<T> where T : MxMapsBase<T>
{
    ...
    /// <returns></returns>
    public Task<TmxActionResponse?> AddMapToMappackAsync(long mappackId, string trackId, string secret, CancellationToken cancelToken = default) =>
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxActionResponse?> ChangeMapStatusInMappackAsync(long id, string mIdString, TmxStatus status, string secret, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .WithQueryParam("secret", secret)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMapAsync(long id, string? shortName = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMapImageHqAsync(long id, int pos, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMapImageLqAsync(long id, int pos, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMapImageSafeAsync(long id, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMapThumbnail(long id, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMappack(long id, string? secret = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("secret", secret)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<Stream> DownloadMappackThumbnailAsync(long id, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMapAuthor[]?> GetMapAuthorsAsync(long id, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMapInfo[]?> GetMapInfoAsync(CancellationToken cancelToken = default, params long[] ids) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMapInfo?> GetMapInfoAsync(long id, string? shortName = null, CancellationToken cancelToken = default) => 
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("shortName", shortName)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMapInfo?> GetMapInfoAsync(string uid, string? shortName = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("shortName", shortName)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMapObject[]?> GetMapObjectsAsync(long id, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMappackInfo?> GetMappackInfoAsync(long id, string? secret = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("secret", secret)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMappackMapInfo[]?> GetMappackMapsAsync(long id, string? secret = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("secret", secret)
    ...
    /// <returns></returns>
    [Obsolete]
    public Task<TmxMapInfo?> GetTrackInfoByUidAsync(string uid, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxUserInfo?> GetUserInfoAsync(long userId, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxActionResponse?> RemoveMapFromMappackAsync(long id, string mIdString, string secret, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxVideoSearchResult?> SearchMapVideosAsync(Action<TmxMapVideoSearchOptions>? searchOptions = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMappackSearchResult?> SearchMappacksAsync(Action<TmxMappackSearchOptions>? searchOptions = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("api", "on")
            .WithQueryParam("format", TmxOutputFormat.Json)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxMapSearchResult?> SearchMapsAsync(Action<TmxMapSearchOptions>? searchOptions = null, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
            .WithQueryParam("api", "on")
            .WithQueryParam("format", TmxOutputFormat.Json)
    ...
    /// <param name="cancelToken"></param>
    /// <returns></returns>
    public Task<TmxSimpleUserInfo[]?> SearchUsersSimpleAsync(string query, CancellationToken cancelToken = default) =>
        WithCancelToken(cancelToken)
            .CacheResponseFor(CacheTime)
